...
export default class BarreDeVie {
    ...
    creerBarre() {
        ...
        BarreDeVie.affichage.innerHTML += "<div id=\"conteneur" + "\"><div id= \"bordure" + "\" style=\"width:500px; margin:50px auto; border: 2px solid black;\"><div id=\"barredevie" + "\" style=\"background-color:" + this.couleur + ";width:" + this.vie + "%; height:20px; text-align:center; color:#FFF;\"></div></div></div>"
